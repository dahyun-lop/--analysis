...
st.info("""
**💡 인사이트 (가설 1 검증)**
* 경제활동인구총괄 통계상 경제활동참가율이 증가하는 추세입니다. 
* 연령과 별개로 다양한 형태의 경제활동이 진행 중이며, 경제활동인구와 별개로 지역별 산업이 영향을 받아 산업동향을 확인할 필요가 있습니다.
""")
...
st.info("""
**💡 인사이트 (가설 2 검증)**
* 취약한 제조업 기반과 달리, '숙박 및 음식점업' 및 '문화/기타 서비스업' 등 관광 관련 산업이 상위권에 위치해 있습니다.
* 이는 급격한 고령화로 전통적 생산 인구가 감소해도, 지역의 특수성을 살린 관광 마케팅 및 서비스 산업 활성화를 통해 경제의 총부가가치를 유의미하게 방어하고 보완할 수 있음을 입증합니다.
""")
